...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/battle/waiting-room" component={() => <Dashboard user={user} activeTab="battle" battleSubTab="waiting-room" />} />
      <Route path="/battle/fight" component={() => <Dashboard user={user} activeTab="battle" battleSubTab="fight" />} />
